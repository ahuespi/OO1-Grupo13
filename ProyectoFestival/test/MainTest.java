...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            LocalDate inicioVerano = LocalDate.of(2026, 1, 10);
            LocalDate finVerano    = LocalDate.of(2026, 1, 20);
            sistema.agregarFestival(
                    "Festival Verano 2026", "Verano",
                    inicioVerano, finVerano,
                    500.0, 10.0, 2000.0, 100000.0, 5000.0
            );

            LocalDate inicioInvierno = LocalDate.of(2026, 7, 5);
            LocalDate finInvierno    = LocalDate.of(2026, 7, 15);
            sistema.agregarFestival(
                    "Festival Invierno 2026", "Invierno",
                    inicioInvierno, finInvierno,
                    500.0, 10.0, 2000.0, 100000.0, 5000.0
            );

            LocalDate inicioPrimavera = LocalDate.of(2026, 9, 21);
            LocalDate finPrimavera    = LocalDate.of(2026, 9, 30);
            sistema.agregarFestival(
                    "Festival Primavera 2026", "Primavera",
        ...
        System.out.println("\nFestivales registrados en el sistema:");
        ...
        System.out.println("\nUnidades de venta registradas en el sistema:");
        ...
        System.out.println("=========================================================");
        try {
            sistema.agregarPlato("FT12345678", "Hamburguesa Doble", 5000.0, 2000.0);
            sistema.agregarPlato("FT12345678", "Papas Rusticas", 2500.0, 1000.0);
            try {
                sistema.agregarPlato("FT12345678", "Hamburguesa Doble", 6000.0, 2500.0);
            } catch (Exception e) {
                System.out.println("Error esperado (Plato duplicado): " + e.getMessage());
            }

            // Agregar platos a la nueva unidad FT99999999, PD12345678 y PD99999999
            sistema.agregarPlato("FT99999999", "Tacos de Carne", 4000.0, 1800.0);
            sistema.agregarPlato("PD12345678", "Choripan", 3000.0, 1000.0);
            sistema.agregarPlato("PD12345678", "Bondiola", 4500.0, 1500.0);
            sistema.agregarPlato("PD99999999", "Empanada Criolla", 1200.0, 500.0);
            sistema.agregarPlato("PD99999999", "Locro", 6000.0, 2500.0);
        } catch (Exception e) {
            System.err.println("Error al agregar platos: " + e.getMessage());
        }

        System.out.println("\nPlatos registrados por Unidad de Venta:");
        for (UnidadDeVenta u : sistema.getLstUnidades()) {
            if (!u.getLstPlatos().isEmpty()) {
                System.out.println("Unidad: " + u.getNombreComercial() + " (" + u.getCodigo() + "):");
                for (Plato p : u.getLstPlatos()) {
                    System.out.println("  - " + p);
                }
            }
        }
        ...
        System.out.println("=========================================================");
        try {
            System.out.println("Canon de Food Truck '" + sistema.traerUnidad("FT12345678").getNombreComercial() + "': $" + sistema.traerUnidad("FT12345678").calcularCanon(sistema.traerFestival("Festival Verano 2026")));

            System.out.println("Canon de Puesto Desarmable '" + sistema.traerUnidad("PD12345678").getNombreComercial() + "': $" + sistema.traerUnidad("PD12345678").calcularCanon(sistema.traerFestival("Festival Verano 2026")));

            System.out.println("Canon de Food Truck '" + sistema.traerUnidad("FT99999999").getNombreComercial() + "': $" + sistema.traerUnidad("FT99999999").calcularCanon(sistema.traerFestival("Festival Primavera 2026")));
        } catch (Exception e) {
        ...
        System.out.println("=========================================================");
        try {
            Festival festivalVerano = sistema.traerFestival("Festival Verano 2026");
        ...
        try {
            ...
            sistema.agregarPedido(LocalDate.now(), "Festival Verano 2026", "FT12345678");
            
            // 2. Agregamos el plato al pedido usando el método de la clase Sistema
            sistema.agregarItemAPedido(1, sistema.traerUnidad("FT12345678").traerPlato("Hamburguesa Doble"), 2);
            sistema.agregarItemAPedido(1, sistema.traerUnidad("FT12345678").traerPlato("Papas Rusticas"), 1);

            // Nuevos pedidos para tener más datos en los siguientes Casos de Uso
            sistema.agregarPedido(LocalDate.now().minusDays(1), "Festival Verano 2026", "PD12345678");
            int idPed2 = sistema.getLstPedidos().size();
            sistema.agregarItemAPedido(idPed2, sistema.traerUnidad("PD12345678").traerPlato("Choripan"), 10);
            sistema.agregarItemAPedido(idPed2, sistema.traerUnidad("PD12345678").traerPlato("Bondiola"), 5);

            sistema.agregarPedido(LocalDate.now(), "Festival Primavera 2026", "PD99999999");
            int idPed3 = sistema.getLstPedidos().size();
            sistema.agregarItemAPedido(idPed3, sistema.traerUnidad("PD99999999").traerPlato("Empanada Criolla"), 20);
            sistema.agregarItemAPedido(idPed3, sistema.traerUnidad("PD99999999").traerPlato("Locro"), 3);

            sistema.agregarPedido(LocalDate.now().minusDays(2), "Festival Invierno 2026", "FT12345678");
            int idPed4 = sistema.getLstPedidos().size();
            sistema.agregarItemAPedido(idPed4, sistema.traerUnidad("FT12345678").traerPlato("Hamburguesa Doble"), 4);
            
            // Error esperado: Festival inexistente
            sistema.agregarPedido(
                    LocalDate.now(),
                    "Festival Inexistente 2026",
                    "FT12345678"
            );
        } catch (Exception e) {
        ...
        for (Pedido p : sistema.getLstPedidos()) {
            ...
            for (ItemPlatoPedido item : p.getItems()) {
                System.out.println("  - " + item.getPlato().getNombre() + " x" + item.getCantidad() + " | Subtotal: $" + item.subtotalVenta());
            }
            System.out.println("  Total Pedido: $" + p.calcularMontoTotal());
        }
        ...
        System.out.println("=========================================================");
        try {
            System.out.println("Recaudación del " + sistema.traerFestival("Festival Verano 2026").getNombre() + ":");
            if(sistema.reporteRecaudacion(sistema.traerFestival("Festival Verano 2026")).isEmpty()) {
                System.out.println("No hubo ventas registradas para este festival.");
            } else {
                for (ReporteVenta rv : sistema.reporteRecaudacion(sistema.traerFestival("Festival Verano 2026"))) {
        ...
        try {
            ...
            // Agregar pedido para la nueva unidad en Festival Primavera 2026
            sistema.agregarPedido(LocalDate.now(), "Festival Primavera 2026", "FT99999999");
            ...
            System.out.println("Pedido para FT99999999 en Festival Primavera 2026 agregado correctamente.");
        } catch (Exception e) {
        ...
        try {
            sistema.agregarPedido(LocalDate.now().minusDays(5), "Festival Verano 2026", "FT12345678");
        ...
        try {
                ...
                System.out.println("Ranking de Unidades para 'Festival Verano 2026':");
                List<UnidadDeVenta> ranking = sistema.rankingUnidad(sistema.traerFestival("Festival Verano 2026"));
                for (UnidadDeVenta u : ranking) {
                    double rec = u.calcularRecaudacion(sistema.getLstPedidos(), sistema.traerFestival("Festival Verano 2026"));
        ...
        try {
            ...
            System.out.println("Plato estrella de 'Food Truck Norte' en 'Festival Verano 2026': " 
                    + (estrella != null ? estrella.getNombre() : "Ninguno"));

            UnidadDeVenta ftSur = sistema.traerUnidad("FT99999999");
            Festival festivalPrimavera = sistema.traerFestival("Festival Primavera 2026");
            Plato estrellaSur = sistema.platoEstrella(ftSur, festivalPrimavera);
            System.out.println("Plato estrella de 'Food Truck Sur' en 'Festival Primavera 2026' (overload): " 
            ...
            System.out.println("Plato estrella de 'Puesto Oeste' en 'Festival Verano 2026' (sin ventas): " 
        ...
        try {
            sistema.eliminarFestival("Festival Invierno 2026");
            System.out.println("Festival 'Festival Invierno 2026' eliminado correctamente.");
        ...
        System.out.println("=========================================================");
        try {
            System.out.println("--- 12.1 PERSONAL DEL FESTIVAL VERANO 2026 ---");
            Festival festivalVerano = sistema.traerFestival("Festival Verano 2026");
            ...
            System.out.println("\n--- 12.2 PERSONAL DEL FESTIVAL PRIMAVERA 2026 ---");
            Festival festivalPrimavera = sistema.traerFestival("Festival Primavera 2026");
            ...
            try {
                Festival festivalInexistente = new Festival(99, "Inexistente 2026", "Otoño", LocalDate.now(), LocalDate.now(), 0, 0, 0, 0, 5000.0);
        ...
        try {
            ...
            sistema.agregarFestival("Festival Canon Pocos 2026", "Verano", inicioTestPocos, finTestPocos, 1000.0, 10.0, 500.0, 50000.0, 5000.0);
            Festival festPocos = sistema.traerFestival("Festival Canon Pocos 2026");
            ...
            try {
                Festival festInexistente = new Festival(999, "Inexistente 2026", "Otoño", LocalDate.now(), LocalDate.now(), 0, 0, 0, 0, 5000.0);
